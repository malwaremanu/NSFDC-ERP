            ...
            <div class="col-span-3">
              ...
              <div class="mt-10 text-center flex flex-col gap-2 items-center">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <a target="_blank" class="hidden" href="http://l2.bankmill.in:8548/rgda/index.html?organization=636a392e5a1863baa1716512" >
                    <button class="w-full px-4 py-2 bg-green-700 m-2 text-white rounded-full select-none cursor-pointer" 
...
export default {
  data(){
    return {
      ...
      totalImages : 6,
      auth_path : '',
      // line : 'https://auth0.manupal.dev/c/ccvkwpl41wm1?r=https://erp.nsfdcdigital.in/auth'
      line : 'checking'
    }
  },
  ...
  mounted() {
    ...
    // Replacing 'login' with 'auth' in the URL
    const modifiedURL = currentURL.replace('/login', '/auth');
    
    // Assigning the modified URL to the data property
    this.auth_path = modifiedURL;

    this.line = this.$store.state.auth_domain + '/c/' + this.$store.state.org_id + '?r=' + modifiedURL
